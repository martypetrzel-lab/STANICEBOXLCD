...
const valid={DATABASE_URL:"postgresql://user:pass@localhost:5432/stanicebox",SESSION_SECRET:"0123456789abcdef",ADMIN_USERNAME:"Hasici",ADMIN_PASSWORD:"150150",DEVICE_API_KEY:"0123456789abcdef"};
